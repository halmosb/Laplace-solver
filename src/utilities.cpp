...
void Utilities::save_print_results(const ParameterList& plist, const Array2D& data, int num_of_iterations) {
    if (plist.output >= 2) {
        std::cout << "Calculation finished after " <<
            num_of_iterations << " iterations, the result is:" << std::endl;
